...
//mailsender.cpp
//from http://forum.qtfr.org/viewtopic.php?id=7736&p=1
...
QString MailSender::mailData()
{
    ...
    data.append("Content-Type: Multipart/Mixed;\r\n boundary=\"" + boundary1 + "\"\n");
...
*/
    // Stephane. Everything is in UTF8 now... don't need a codec.
    data.append(_body);
